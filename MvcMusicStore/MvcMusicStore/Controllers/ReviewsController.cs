...
namespace MvcMusicStore.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ReviewId,AlbumId,Contents,ReviewerEmail")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ReviewId,AlbumId,Contents,ReviewerEmail")] Review review)
        {
            if (ModelState.IsValid)
            {
