...
namespace MVCMusicStoreWithAuthentication.Controllers
{
    public class BandsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BandId,BandName,Website,ArtistId")] Band band)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BandId,BandName,Website,ArtistId")] Band band)
        {
            if (ModelState.IsValid)
            {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult ArtistAdd([Bind(Include = "ArtistId")] Artist artist)
        //{
        //    if (ModelState.IsValid)
        //    {
